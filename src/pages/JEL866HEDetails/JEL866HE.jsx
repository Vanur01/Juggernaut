  ...
  return (
    ...
    <Box
      ...
      sx={{
        ...
        backgroundImage: `linear-gradient(to right, rgba(0,0,0,0.7) 30%, rgba(0,0,0,0.3)), url(${JEL866HE})`,
    ...
    >
      ...
      <Box sx={{ position: 'relative', zIndex: 1 }}>
        ...
        >
          {[
            { value: '8500', unit: 'kg', label: 'Payload Capacity' },
            { value: '134.1', unit: 'HP (100 kW)', label: 'Rated Power' },
            { value: '2.1 - 4.2', unit: 'm³', label: 'Bucket Capacity' }
          ].map((stat, index) => (
            <Grid 
              item 
              xs={12} 
