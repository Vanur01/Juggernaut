  ...
  return (
    ...
    <Box
      ...
      sx={{
        ...
        backgroundImage: `linear-gradient(to right, rgba(0,0,0,0.7) 30%, rgba(0,0,0,0.3)), url(${JEL876HE})`,
    ...
    >
      ...
      <Box sx={{ position: 'relative', zIndex: 1 }}>
        ...
        >
          {[
            { value: '6000', unit: 'kg', label: 'Payload Capacity' },
            { value: '147.5', unit: 'HP (110 kW)', label: 'Rated Power' },
            { value: '2.0 - 3.2', unit: 'm³', label: 'Bucket Capacity' }
          ].map((stat, index) => (
            <Grid 
              item 
              xs={12} 
