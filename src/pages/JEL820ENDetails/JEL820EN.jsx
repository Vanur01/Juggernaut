  ...
  return (
    ...
    <Box
      ...
      sx={{
        ...
        backgroundImage: `linear-gradient(to right, rgba(0,0,0,0.7) 30%, rgba(0,0,0,0.3)), url(${JEL820EN})`,
    ...
    >
      ...
      <Box sx={{ position: 'relative', zIndex: 1 }}>
        ...
        >
          {[
            { value: '2000', unit: 'kg', label: 'Payload Capacity' },
            { value: '53.6', unit: 'HP (40 kW)', label: 'Rated Power' },
            { value: '0.8 - 1.2', unit: 'm³', label: 'Bucket Capacity' }
          ].map((stat, index) => (
            <Grid 
              item 
              xs={12} 
